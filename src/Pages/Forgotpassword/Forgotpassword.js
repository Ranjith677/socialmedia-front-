...
const handleclick = async(e)=>{
  e.preventDefault();
  await fetch(`https://social-media-server-back.onrender.com/api/user/forgot/password` , {method:"POST" , headers:{"Content-Type":"application/JSON"} , body:JSON.stringify({email:email})}).then(()=>{
